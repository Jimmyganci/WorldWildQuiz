...
const Header = () => {
  ...
  return (
    <div className="header">
      ...
      {/* ***** Link Home ***** */}
      {openModal && window.location.pathname === '/WorldWildQuiz/' ? (
        <Modal
          openModal={openModal}
          showModal={showModal}
          hideModal={hideModal}
      ...
      {/* ***** Link Quiz ***** */}
      {openModal && window.location.pathname === '/WorldWildQuiz/Quiz' ? (
        <Modal
          openModal={openModal}
          showModal={showModal}
          hideModal={hideModal}
      ...
      {/* ***** Link Quiz ***** */}
      {openModal && window.location.pathname === '/WorldWildQuiz/quizrapid' ? (
        <Modal
          openModal={openModal}
          showModal={showModal}
          hideModal={hideModal}
      ...
      {/* ***** Link Memory ***** */}
      {openModal && window.location.pathname === '/WorldWildQuiz/Memory' ? (
        <Modal
          openModal={openModal}
          showModal={showModal}
          hideModal={hideModal}
        >
          ...
          <div className="modalFullInfo">
            <h3>
              ...
              click on Play! <br /> <br />
              To win, you must turn over the cards, which hideflags, by clicking
              on them. <br /> <br />
      ...
      {/* ***** Link Culture ***** */}
      {openModal && window.location.pathname === '/WorldWildQuiz/Culture' ? (
        <Modal
          openModal={openModal}
          showModal={showModal}
          hideModal={hideModal}
      ...
      {/* ***** Link Classement ***** */}
      {openModal && window.location.pathname === '/WorldWildQuiz/Classement' ? (
        <Modal
          openModal={openModal}
          showModal={showModal}
          hideModal={hideModal}
      ...
      <li>
        <NavLink activeClassName="active" to="/WorldWildQuiz/Classement">
          Classement
        </NavLink>
      </li>
